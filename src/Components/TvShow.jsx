...
const filterOptions = [
  { value: "airing_today", label: "Airing Today", icon: "ri-tv-2-fill" },
  { value: "on_the_air", label: "On The Air", icon: "ri-broadcast-fill" },
...
const TvShow = () => {
  ...
  document.title = "TV Shows | CineMate";
    ...
    <div className="w-full h-screen bg-[#0f1014] overflow-hidden flex flex-col font-sans select-none relative">
      ...
      <div id="scrollableDiv" className="flex-1 w-full overflow-y-auto overflow-x-hidden relative z-20 custom-scrollbar">
        ...
        <div className="px-5 md:px-12 lg:px-16 mb-4 md:mb-6 w-full max-w-4xl mt-6 lg:mt-8">
          ...
          >
            Explore <span className="text-[#6556CD]">Series</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Binge-worthy narratives and acclaimed television series.
