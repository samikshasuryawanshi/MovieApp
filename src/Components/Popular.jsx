...
const filterCategoryOptions = [
  { value: "movie", label: "Movies", icon: "ri-film-fill" },
  { value: "tv", label: "TV Shows", icon: "ri-tv-fill" }
];
    ...
    <div className="w-full h-screen bg-[#0f1014] overflow-hidden flex flex-col font-sans select-none relative">
      ...
      <div id="scrollableDiv" className="flex-1 w-full overflow-y-auto overflow-x-hidden relative z-20 custom-scrollbar">
        ...
        <div className="px-5 md:px-12 lg:px-16 mb-4 md:mb-6 w-full max-w-4xl mt-6 lg:mt-8">
          ...
          >
            Whats <span className="text-[#6556CD]">Popular</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Explore the absolute fan favorites. See the movies and TV shows everyone is currently obsessed with.
          </motion.p>
          <motion.div
